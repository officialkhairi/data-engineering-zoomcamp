...
@click.option('--year', default=2021, show_default=True, type=int, help='Year of the trip data')
@click.option('--month', default=1, show_default=True, type=int, help='Month of the trip data')
